...
public class PlayDrawingTool extends Tool {
    ...
    // MODIFIES: this
    // EFFECTS:  constructs an ActionListener which is then added to this object's JButton field.
	@Override
	protected void addListener() {
		button.addActionListener(new PlayDrawingToolButtonClickHandler());
	}
    ...
    private class PlayDrawingToolButtonClickHandler implements ActionListener {
		@Override
